...
public class AmethystBracelet extends Item implements ICurioItem, ManaIncreasingItem {
    ...
    public void onEquip(SlotContext slotContext, ItemStack prevStack, ItemStack stack) {
        ...
        if (isMage(player)) {
            increaseMana(player);
            player.sendSystemMessage(Component.translatable("sbm.curios.amethyst_bracelet.dressed").withStyle(ChatFormatting.LIGHT_PURPLE));
        }
        else{player.sendSystemMessage(Component.translatable("sbm.curios.amethyst_bracelet.warn").withStyle(ChatFormatting.RED));}
    }
    ...
    public void onUnequip(SlotContext slotContext, ItemStack newStack, ItemStack stack) {
        Player player = (Player) slotContext.entity();
        decreaseMana(player);
        player.sendSystemMessage(Component.translatable("sbm.curios.amethyst_bracelet.undressed").withStyle(ChatFormatting.LIGHT_PURPLE));
    }
